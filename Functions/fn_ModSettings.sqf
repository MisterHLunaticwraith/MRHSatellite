...
["MRH_SAT_allowLasering", "CHECKBOX", [_allowLaseringText, _allowLaseringTooltip], "MRHSatellite Options", true, 0] call cba_settings_fnc_init;
...
["MRH_SAT_MaxSatAltitude", "SLIDER", [_setMaxHeightText, _setMaxHeightTooltip], "MRHSatellite Options", [10, 1000, 1000, 0], 1] call cba_settings_fnc_init;